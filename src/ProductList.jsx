    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Hyacinth", image: "https://cdn.pixabay.com/photo/2019/04/07/20/20/hyacinth-4110726_1280.jpg", description: "Beautiful flowering plant known for fragrance.", cost: "$22" }
            ]
        },
        // Remaining categories — unchanged (kept as-is)
        // ...
    ];
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div><a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>Cart ({calculateTotalQuantity()})</h1>
                    </a></div>
                </div>
            </div>
